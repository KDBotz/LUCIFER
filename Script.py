...
just paste my username in any chat
add a space and enter movie or series name
or ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴇɴᴊᴏʏ.
tutorial : mmp_links
</b>"""
...
<b>✯ Cʀᴇᴀᴛᴏʀ : <a href=https://t.me/mastermindmayank>Mastermind Mayank</a></b>

<b>✯ Uᴘᴅᴀᴛᴇs : <a href=https://t.me/mmp_links>MMP Links</a></b>

<b>✯ Bᴜɪʟᴅ Sᴛᴀᴛᴜs : ᴠ1.0.62 [Sᴛᴀʙʟᴇ]</b>"""

    SOURCE_TXT ="""
<b>message creator to built a bot for you or get source code

- Sᴏᴜʀᴄᴇ - <a href=https://t.me/mastermindmayank</a></b>
"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/mastermindmayank)</code>
...
<b><a href=https://t.me/mmp_links>~ ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ Mastermind Mayank Project</a></b>"""
...
Request in @mmp_request_group</b>
"""
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : Mastermind Mayank『🇮🇳』
• ᴜꜱᴇʀɴᴀᴍᴇ : @mastermindmayank
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/mastermindmayank'>click here</a></b>
"""
...
<b>Exᴀᴍᴘʟᴇ:</b>
<code>/batch https://t.me/mmp_links/1 
https://t.me/mmp_links/9</code>
"""
...
♕♕ Pᴏᴡᴇʀᴇᴅ Bʏ : Mastermind Mayank Project ♕♕
"""
...
<code>{}</code> Rᴇsᴜʟᴛs Aʀᴇ Aʟʀᴇᴀᴅʏ Aᴠᴀɪʟᴀʙʟᴇ Fᴏʀ Yᴏᴜʀ Rᴇǫᴜᴇsᴛ <code>{}</code> Iɴ <a href=https://t.me/{}>MMP Bots</a>.</b>
"""
...
"""
    ...
    REQ_REJECT = """
Tʜᴇ Rᴇǫᴜᴇsᴛ Is Rᴇᴊᴇᴄᴛᴇᴅ Dᴜᴇ Tᴏ Sᴀᴍᴇ request already available or Nᴏᴛ Iɴ Fᴏʀᴍᴀᴛ !!
"""
...
Yᴏᴜʀ Rᴇǫᴜᴇsᴛ Aʟʀᴇᴀᴅʏ Mᴀʏʙᴇ Iɴ Tʜᴇ Rᴇǫᴜᴇsᴛ Lɪsᴛ Oʀ Yᴏᴜʀ Rᴇǫᴜᴇsᴛ Is not in proper. Kɪɴᴅʟʏ Rᴇǫᴜᴇsᴛ Aɢᴀɪɴ Oʀ Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ Fᴏʀ Hᴇʟᴘ.</b>
"""

    REQ_NO2 = """
<b>Sᴏʀʀʏ Yᴏᴜʀ Rᴇǫᴜᴇsᴛ Nᴏᴛ Aᴠᴀɪʟᴀʙʟᴇ,
Kɪɴᴅʟʏ Cᴏɴᴛᴀᴄᴛ @mastermindmayank Fᴏʀ Hᴇʟᴘ.</b>
"""
