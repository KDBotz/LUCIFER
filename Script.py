...
<a href='t.me/FILTER_LUCIFER_BOT'>‣ Tʜɪs Mᴇssᴀɢᴇ Wɪʟʟ ʙᴇ Aᴜᴛᴏ-Dᴇʟᴇᴛᴇᴅ Aғᴛᴇʀ 𝟷𝟶 Mɪɴᴜᴛᴇs. Kɪɴᴅʟʏ Fᴏʀᴡᴀʀᴅ Yᴏᴜʀ Fɪʟᴇs Tᴏ Sᴀᴠᴇᴅ.</a></b>"""

    FILE_READY_TXT = """
<b>Hᴇʏ {}
 
📫 Yᴏᴜʀ Fɪʟᴇ Is Rᴇᴀᴅʏ & Fɪʟᴇ Aʀᴇ Sᴇɴᴛ Tᴏ Fɪʟᴇs Cʜᴀɴɴᴇʟ, Cʜᴇᴄᴋ Dᴏᴡɴ Tᴏ Vɪᴇᴡ.
